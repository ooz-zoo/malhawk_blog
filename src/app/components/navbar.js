        ...
        <div className="flex items-center gap-3 group">
          <div className="relative">
            <img 
              src="/logo.ico" 
              alt="MALHAWK Logo" 
              className="w-12 h-12 object-contain rounded-lg border-2 border-[#00FF41] shadow-glow"
            />
            <div className="absolute inset-0 border-2 border-cyan-400 rounded-lg opacity-0 group-hover:opacity-40 transition-opacity duration-300"></div>
          </div>
            ...
            <li>
              <a 
                ...
                className={`flex items-center gap-2 text-lg tracking-widest group transition-all duration-300 ${
                  pathname === '/about' ? 'text-[#00FF41]' : 'text-gray-300 group-hover:text-[#00FF41]'
                }`}
              >
